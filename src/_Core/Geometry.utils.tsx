...
function interpolatePath(point1: Point, point2: Point) {
  ...
  const point2x: number = point2.x;
  const point2y: number = point2.y;
  const line: Point[] = [];
...
export function octile(node1: Point, node2: Point): number {
...
export function manhattan(node1: Point, node2: Point): number {
